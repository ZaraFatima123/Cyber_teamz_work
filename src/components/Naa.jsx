  ...
  return (
    <nav className={`navbar navbar-expand-lg ${darkMode ? "navbar-dark bg-dark" : "navbar-light bg-light"}`}>
      <div className="container-fluid">
        <Link className="navbar-brand" to="/">Smart Securers</Link>
        <button 
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item"><Link className="nav-link" to="/cyber">Cyber Threat Map</Link></li>
          </ul>

          {/* User Settings Button */}
          <button className="btn btn-outline-secondary ms-3" data-bs-toggle="modal" data-bs-target="#settingsModal">
      ...
      <div className="modal fade" id="settingsModal" tabIndex="-1" aria-labelledby="settingsModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className={`modal-content p-3 ${darkMode ? "bg-dark text-white" : "bg-light text-dark"}`}>
            ...
            <div className="modal-body d-flex flex-column gap-3">
              ...
              <div className="dropdown">
                <button className="btn btn-outline-secondary dropdown-toggle" type="button" id="accountDropdown" data-bs-toggle="dropdown">
                  Account Options
                </button>
                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="accountDropdown">
                  <li><Link className="dropdown-item" to="/login">Login</Link></li>
                  <li><button className="dropdown-item" data-bs-dismiss="modal">Close</button></li>
                </ul>
              </div>
            </div>
          </div>
